...
parser.add_argument('--data_file', default="data/MQ2007/Fold1/test.txt", type=str, help='data file')
parser.add_argument('--output_dir', default="data/MQ2007/Fold1/test_json", type=str, help='output_dir file')
